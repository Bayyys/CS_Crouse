...
import com.example.chapter05.database.LoginDBHelper;
import com.example.chapter05.enity.LoginInfo;
import com.example.chapter05.util.ViewUtil;

import java.util.Random;

public class LoginMainSQLiteActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener, View.OnFocusChangeListener {
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            if (s.toString().length() == mMaxLength) {
                // 隐藏输入法软键盘
                ViewUtil.hideOneInputMethod(LoginMainSQLiteActivity.this, mView);
            }
        }
    }
}